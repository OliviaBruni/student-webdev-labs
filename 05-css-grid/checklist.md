...
<!--^ was given section heading warnings, otherwise code is valid. There was not much to be done with these warnings given the semantic setup of the HTML file.-->
